              ...
              <div class=""style="margin-left: 2%; margin-right: 2%">
                <div class="row" style="margin-top: 20px;">
                  <div class="col-md-12">
                    ...
                    text-align: center;">All <b>Products</b></h2>
                  </div>
                </div>
              </div>
                    ...
                    @foreach ($product as $item)
                      <div class="col-sm-3 my-1">
                        <div class="thumb-wrapper" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                          ...
                          <div class="img-box">
                            <img src="/product_picture/{{$item->image}}" class="img-fluid" style="display: block; margin: 0 auto; text-align: center; max-width: 100%; height: 100px;" alt="">
                            <div class="overlay">
                              <a href="#" class="btn btn-primary" onclick="showFullImage(event, '{{$item->image}}')">View Full Image</a>
                            </div>
                          </div>
                          <div class="thumb-content mt-2">
                            <h4 style="min-height: 57px; font-size: 1.5rem !important;">{{$item->title}}</h4>
                            <p class="item-price"><strike>{{$item->price}}tk</strike> <b>{{$item->discount_price}}tk</b></p>
                            <a href="{{url('add_cart',$item->id)}}" class="btn btn-primary btn-size">Add to Cart</a>
                            <a href="{{url('details',$item->id)}}" class="btn btn-primary btn-size">Details</a>
                          </div>
                        </div>
                      </div>
                    @endforeach
