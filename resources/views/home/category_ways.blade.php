              ...
              <div class=""style="margin-left: 2%; margin-right: 2%">
                <div class="row" style="margin-top: 20px;">
                  <div class="col-md-12">
                    ...
                    text-align: center;">{{$category_name}} Category <b>Products</b></h2>
                  </div>
                </div>
              </div>

              <div class="row scrollable-table" style="margin-left: 2%; margin-right: 1%">
                      ...
                      <div class="col-sm-3 my-1">
                        <div class="thumb-wrapper" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                          ...
                          <div class="thumb-content mt-2">
                            <h4 style="text-align: center; min-height: 57px; font-size: 1.5rem !important;">{{$product->title}}</h4>
                            <p class="item-price" style="text-align: center"><strike>{{$product->price}}tk</strike> <b>{{$product->discount_price}}tk</b></p>
                            <div style="text-align: center; padding-bottom: 10px;">
                              <a href="{{url('add_cart',$product->id)}}" class="btn btn-primary btn-size" style="margin-bottom: 5px;">Add to Cart</a>
                              <a href="{{url('details',$product->id)}}" class="btn btn-primary btn-size" style="margin-bottom: 5px;">Details</a>
                          </div>
                          </div>
                        </div>
                      </div>
