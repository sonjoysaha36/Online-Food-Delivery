           ...
           @if(session()->has('message'))
            ...
            <div class="row min-vh-100 bg-black">
              ...
              <div class="div_center">
                <h2 class="h2_font">Add Food</h2>
                <form action="{{url('add_food')}}" method="POST" enctype="multipart/form-data" class="col-md-5 div_center_form">
                  @csrf
                  <div class="mb-3">
                    <label for="title" class="form-label">Food Title</label>
                    <input type="text" class="form-control" name="title" id="" placeholder="Write Food title" required>
                  </div>
                  {{-- <div class="mb-3">
                ...
                <script>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" min="0" class="form-control" name="price" id="" placeholder="Food Price" required>
                  </div>
                  <div class="mb-3">
                    <label for="Price" class="form-label">Food Discount Price</label>
                    <input type="number" min="0" class="form-control" name="dis_price" id="" placeholder="Write if any discount available">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <label for="formFile" class="form-label">Food Image Here</label>
